...
class TestWithExistingDirs:
    def test_tag_value_exists_returns_tag(self, tmp_campaign):
        spec = {
    ...
    def test_tag_value_no_exists_returns_none(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["test"]
        }
    ...
    def test_tag_values_both_exist_returns_first(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["test"]
        }
    ...
    def test_no_tag_returns_none(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["test"]
        }
    ...
    def test_has_second_tag_returns_second(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["brains", "test"]
        }
    ...
    def test_both_tags_exist_returns_first(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["brains", "test"]
        }
...
class TestWithNonExistingDirs:
    def test_has_tag_returns_tag(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["test"]
        }
    ...
    def test_has_tag_returns_first_value(self, tmp_campaign):
        spec = {
            "selector": "first_value",
            "tags": ["test"]
        }
