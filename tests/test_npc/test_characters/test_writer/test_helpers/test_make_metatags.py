...
def test_returns_matching_metatag(db):
    metatag_def = {
        "desc": "A testing tag",
        "static": {
            "test": "yes"
...
def test_returns_multiple_metatags_when_greedy(db):
    metatag_def = {
        "desc": "A testing tag",
        "static": {
            "test": "yes"
...
def test_returns_used_ids_from_multiple(db):
    metatag_def = {
        "desc": "A testing tag",
        "static": {
            "test": "yes"
