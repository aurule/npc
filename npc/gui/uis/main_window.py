...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpen_Campaign = QtWidgets.QAction(MainWindow)
        icon = QtGui.QIcon.fromTheme("folder-open")
        self.actionOpen_Campaign.setIcon(icon)
        self.actionOpen_Campaign.setObjectName("actionOpen_Campaign")
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionOpen_Campaign)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionUserSettings.setText(_translate("MainWindow", "&User"))
        self.actionUserSettings.setToolTip(_translate("MainWindow", "Open user settings"))
        self.actionOpen_Campaign.setText(_translate("MainWindow", "&Open Campaign..."))
        self.actionOpen_Campaign.setShortcut(_translate("MainWindow", "Ctrl+O"))
