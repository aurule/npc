...
"}")
        ...
        self.actionClear_Recent_Camaigns = QtWidgets.QAction(MainWindow)
        icon = QtGui.QIcon.fromTheme("edit-clear")
        self.actionClear_Recent_Camaigns.setIcon(icon)
        self.actionClear_Recent_Camaigns.setObjectName("actionClear_Recent_Camaigns")
        self.menuOpen_Recent_Campaign.addSeparator()
        self.menuOpen_Recent_Campaign.addAction(self.actionClear_Recent_Camaigns)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionClear_Recent_Camaigns.setText(_translate("MainWindow", "Clear Items"))
        self.actionClear_Recent_Camaigns.setToolTip(_translate("MainWindow", "Clear recent campaigns"))
