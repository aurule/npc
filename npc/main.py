...
def _make_parser():
    ...
    parser_report.add_argument('-t', '--format', choices=['json', 'htm', 'html'], default='default', help="Format to use for the tables. Defaults to the table format in settings", dest="fmt")
