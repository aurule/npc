...
Released in 2009, Pathfinder 1e is based on D&D 3.5 and remains largely compatable with modules for that older game. It files down some of the rough edges and expands on various mechanics to make a robust foundation for creative gameplay.


Related Links
=============

.. button-link:: https://paizo.com/store/pathfinder/rulebooks/first
    :color: primary
    :shadow:

    Books

.. button-link:: https://pathfinder.d20srd.org/
    :color: primary
    :shadow:
...
.. include:: components/types/pf1_table.rst